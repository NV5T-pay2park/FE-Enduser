/*! For license information please see sdk.js.LICENSE.txt */ ! function(e, r) {
    "object" == typeof exports && "object" == typeof module ? module.exports = r() : "function" == typeof define && define.amd ? define([], r) : "object" == typeof exports ? exports.ZLP = r() : e.ZLP = r()
}(self, (function() {
  return (() => {
    var e = {
        826: () => {
          var e;
          (e = window) && !e.ZaloPay && (e.ZaloPay = function(e) {
            "use strict";
            ...
            function c(e, r) {
              return (e = e || {}).errorCode = e.error || 0, 1 !== e.error ? a("error", r + ": errorCode[" + e.errorCode + "], message[" + e.errorMessage + "]") : a("info", r + ": errorCode[" + e.errorCode + "], message[" + e.errorMessage + "]"), e
            }
            ...
            return (e = e || {}).ua = navigator.userAgent, e.jsVersion = "1.0.0", e.isDebug = !0, e.isZaloPay = e.ua.indexOf("ZaloPayClient") > -1, e.isZaloPay || a("warn", "Run in ZaloPayClient please!"), e.appVersion = function() {
              if (e.isZaloPay) {
              ...
              name: "ZaloPay",
              isZaloPay: e.isZaloPay,
              jsVersion: e.jsVersion,
              ...
              if (window.ZaloPayJSBridge && window.ZaloPayJSBridge.call) {
                ...
                u = function(e) {
                  e = c(e, i), d && d(e)
                }, "writeLog" !== i && a("info", "ZaloPayJSBridge.call", i, l, d), window.ZaloPayJSBridge.call(i, l, u)
              } else {
            ...
            }, e.ready = e.ready || e._ready, e.showLoading = function() {
              e.call("showLoading")
              ...
              o(r) ? n(r.title) && n(r.message) && n(r.button) && (r = {
                type: 2,
                title: r.title,
                message: r.message,
                button: r.button
              }, e.call("showDialog", r)) : a("error", "ZaloPay.showDialog", "Received invalid object")
            }, e.showToast = function(r) {
              o(r) ? n(r.message) && (r = {
                message: r.message
              }, e.call("showToast", r)) : a("error", "ZaloPay.showToast", "Received invalid object")
            }, e.showTooltip = function(r) {
              if (o(r)) {
                var t = s(r.position) && r.position > 1 ? r.position : 0;
                n(r.message) && (n(r.iconName) || n(r.iconLink)) && (r = {
                  message: r.message,
                  iconName: r.iconName,
                  iconLink: r.iconLink,
                  position: t
                }, e.call("showTooltip", r))
              } else a("error", "ZaloPay.showTooltip", "Received invalid object")
            }, e.pushView = function(r) {
              if (o(r)) return n(r.url) ? (r = {
                url: r.url
              }, void e.call("pushView", r)) : void a("error", "ZaloPay.pushView", "Received missing require param!");
              a("error", "ZaloPay.pushView", "Received invalid object")
            }, e.share = function(r) {
              o(r) ? s(r.type) && n(r.caption) && n(r.content) && (r = {
                type: r.type,
                caption: r.caption,
                content: r.content,
                link: r.link,
                showShareButton: r.showShareButton
              }, e.call("share", r)) : a("error", "ZaloPay.share", "Received invalid object")
            }, e.payOrder = function(r, t) {
              if (o(r)) return n(r.zptranstoken) ? (a("info", "ZaloPay.payOrder", "Received zptranstoken", r = {
                zptranstoken: r.zptranstoken,
                appid: r.appid
              }), void e.call("payOrder", r, t)) : n(r.mac) ? (a("info", "ZaloPay.payOrder", "Received transinfo", r = {
                appid: r.appid,
                appuser: r.appuser,
                apptime: r.apptime,
                amount: r.amount,
                ...
                mac: r.mac
              }), void e.call("payOrder", r, t)) : void a("error", "ZaloPay.payOrder", "Received missing require param!");
              a("error", "ZaloPay.payOrder", "Received invalid object")
            }, e.transferMoney = function(r, t) {
              if (o(r)) return n(r.zpid) && n(r.message) && s(r.amount) ? (a("info", "ZaloPay.transferMoney", "Received transferMoney", r = {
                zpid: r.zpid,
                amount: r.amount,
                message: r.message
              }), void e.call("transferMoney", r, t)) : void a("error", "ZaloPay.transferMoney", "Received missing require param!");
              a("error", "ZaloPay.transferMoney", "Received invalid object")
            }, e.promotionEvent = function(r) {
              if (o(r)) return s(r.campaignId) && s(r.internalApp) ? (a("info", "ZaloPay.promotionEvent", "Received promotionEvent", r = {
                campaignId: r.campaignId,
                internalApp: r.internalApp,
                alternateUrl: r.alternateUrl,
                deeplinks: r.deeplinks
              }), void e.call("promotionEvent", r)) : s(r.campaignId) && n(r.url) && n(r.packageId) ? (a("info", "ZaloPay.promotionEvent", "Received promotionEvent", r = {
                campaignId: r.campaignId,
                url: r.url,
                packageId: r.packageId,
                alternateUrl: r.alternateUrl,
                deeplinks: r.deeplinks
              }), void e.call("promotionEvent", r)) : void a("error", "ZaloPay.promotionEvent", "Received missing require param!", r);
              a("error", "ZaloPay.promotionEvent", "Received invalid object")
            }, e.setProperty = function(r, n) {
              o(r) ? (a("info", "ZaloPay.setProperty", "Received navigator", r), t(n) ? e.call("setProperty", r, n) : e.call("setProperty", r)) : a("error", "ZaloPay.setProperty", "Received invalid object")
              ...
              if (!r(o) || o.length < 1 || !t(s)) a("error", "ZaloPay.setToolbarActions", "Received invalid object");
                ...
                if (o.forEach((function(e, r) {
                    n(e.iconId) && (n(e.iconLink) ? i.push({
                      iconId: e.iconId,
                      func: s.name,
                      iconLink: e.iconLink,
                      iconName: "",
                      iconColor: ""
                    }) : n(e.iconName) && (n(e.iconColor) ? i.push({
                      iconId: e.iconId,
                      func: s.name,
                      iconLink: "",
                      iconName: e.iconName,
                  ...
                  })), i.length > 0) return e.call("setToolbarActions", {
                  data: i
                }), void document.addEventListener(s.name, s, !1);
                a("error", "ZaloPay.setToolbarActions", "Received missing require param!", o)
              }
            }, e.getUserInfo = function(r, n) {
              t(n) && s(r) ? (a("info", "ZaloPay.getUserInfo", "Received UserInfo in function callback"), e.call("getUserInfo", {
                appid: r
              }, n)) : a("error", "ZaloPay.getUserInfo", "Received invalid function callback")
                    ...
                    return new Promise((function(o) {
                      if (function() {
                        ...
                        if (s) {
                          ...
                          if (document.getElementById("ZPI_SPA_SDK")) o && o({
                            error: -1,
                            message: "SDK already exist"
                          });
                          else {
                            var a = s + "/" + n + "/zpi-spa-sdk.js";
                            i.id = "ZPI_SPA_SDK", i.src = a, o && (i.onload = function() {
                              o({
                                error: 1,
                                message: "Init SDK successfully"
                              })
                            }, i.onerror = function() {
                              o({
                                error: -1,
                                message: "Init SDK failed"
                              })
                            });
                            try {
    ...
    return (() => {
      ...
      class d extends u {
        ...
        async getUserInfo() {
          ...
          let {
            sdk: e,
            appID: t
          } = this.ctx, n = await e.getProfile(t);
          if (n.data) {
      ...
      class h extends p {
        ...
        async getCurLocation() {
          let {
            sdk: e
          } = this.ctx, t = await e.getLocation();
          if (console.log("loc=", t), t.data) return Promise.resolve({
      ...
      class f extends g {
        ...
        payOrder(e, t) {
          return new Promise(((n, o) => {
            ...
            s.showOrderPopup({
              ...
              1 != (null == e ? void 0 : e.error) ? o(new r(e.error, e.message)) : n({
                code: 1,
                message: "Success"
              })
            }))
        ...
        payOrderV2(e, t, n) {
          return new Promise(((o, s) => {
            ...
            i.showOrderPopupWithResultPage({
              zpTransToken: e,
              callbackURL: t,
              zpAppID: a,
              options: n
            }, (e => {
              1 != (null == e ? void 0 : e.error) ? s(new r(e.error, e.message)) : o({
                code: 1,
                message: "Success"
              })
            }))
        ...
        updateResultStatus(e) {
          return Promise.reject(new i("updateResultStatus"))
        }
      }
      class w extends l {
        constructor(e) {
      ...
      class S extends P {
        ...
        trackEvent(t, n) {
          return new Promise(((o, s) => {
            try {
              t = k(t, v.ZPI), this.ctx.sdk.tracking({
                eventID: t,
                metaData: n
              }).then((e => {
      ...
      class I extends c {
        ...
        async init() {
          if (this.isZPI()) return this.onInitSuccess(), Promise.resolve({
            error: 1,
            message: "Init SDK successfully"
          });
          let e = window.ZPI_SPA_SDK;
          return e ? e.init(this.ctx.env, "0.3.6").then((e => 1 == e.error ? (this.onInitSuccess(), e) : Promise.reject(new r(e.error, `Init failed with ${e.message}`)))) : Promise.reject(new s("not in ZaloPay"))
        }
        onInitSuccess() {
          console.log("Init ZPI wrapper"), this.mUser = new d(this.ctx), this.mDevice = new h(this.ctx), this.mPayment = new f(this.ctx), this.mUI = new y(this.ctx), this.mTracking = new S(this.ctx)
        }
        isZPI() {
      ...
      class Z {
        ...
        static ok(e) {
          return new Z(e, void 0)
        }
        static error(e) {
          return new Z(void 0, e)
        }
      }
      class T {
        constructor(e, r, t) {
      ...
      const A = "__miniapps__",
        j = new T(1e3, "ResourceExhausted", "Capacity limit has been reached");
      new T(1001, "InvalidArgument", "Invalid arguments");
      class _ {
        constructor(e) {
      ...
      class z {
        ...
        static getItem(e) {
          try {
            ...
            return Z.error(new T(-1, "UNKNOWN", e.toString()))
          }
        }
        static setItem(e, r) {
          try {
            e = z.formatKey(e);
            let t = new _(r);
            return localStorage.setItem(e, t.toString()), Z.ok(!0)
          } catch (e) {
            return "QuotaExceededError" == e.name ? Z.error(j) : Z.error(new T(-1, "UNKNOWN", e.toString()))
          }
        }
        static removeItem(e) {
          try {
            return e = z.formatKey(e), localStorage.removeItem(e), Z.ok(!0)
          } catch (e) {
            return Z.error(new T(-1, "UNKNOWN", e.toString()))
          }
        }
      ...
      function C(e, r) {
        try {
          ...
          if (t.error) {
            if (t.error == j) {
              let t = x(e + r);
              if (z.cleanUp(t) >= t) return C(e, r)
            }
            return Z.error(t.error)
          }
          return Z.ok(!0)
        } catch (e) {
          return Z.error(new T(-1, "UNKNOWN", e.toString()))
      ...
      let D;
      const L = new T(1e3, "InvalidArgument", "Invalid arguments"),
        R = new T(1001, "ResourceExhausted", "Capacity limit has been reached");
      ...
      class O {
        ...
        loadData() {
          let e = function(e) {
            try {
              let r = z.getItem(e);
              return r.error ? Z.error(r.error) : r.data ? (z.setItem(e, r.data), Z.ok(r.data)) : Z.ok(null)
            } catch (e) {
              return Z.error(new T(-1, "UNKNOWN", e.toString()))
            }
          }(this.storageKey());
        ...
        storageInfo() {
          return Z.ok({
            quota: this.maxCapacity,
            remaining: this.maxCapacity - this.totalSize,
            used: this.totalSize
          })
        }
        getAllItem() {
          return Z.ok(this.items)
        }
        getItem(e) {
          if (e in this.items) {
            let r = this.items[e];
        ...
        setItem(e, r) {
          if (!e || !r) return Z.error(L);
          let t = x(e) + x(r);
          if (this.totalSize + t > this.maxCapacity) return Z.error(R);
          let n = Object.assign({}, this.items);
          n[e] = r;
          let o = C(this.storageKey(), JSON.stringify(n));
          return o.error ? Z.error(new T(o.error.code, o.error.name, o.error.message)) : (this.items = n, this.totalSize += t, Z.ok(!0))
        }
        removeItem(e) {
          if (!(e in this.items)) return Z.ok(!0);
          let r = Object.assign({}, this.items);
          delete r[e];
          let t = C(this.storageKey(), JSON.stringify(r));
          if (t.error) return Z.error(new T(t.error.code, t.error.name, t.error.message));
          let n = x(e) + x(this.items[e]);
          return this.items = r, this.totalSize -= n, Z.ok(!0)
        }
        clearAll() {
          return this.items = {}, this.totalSize = 0,
            function(e) {
              try {
                let r = z.removeItem(e);
                return r.error ? Z.error(r.error) : Z.ok(!0)
              } catch (e) {
                return Z.error(new T(-1, "UNKNOWN", e.toString()))
              }
            }(this.storageKey())
      ...
      class N extends p {
        ...
        openCamera() {
          return new Promise(((t, n) => {
            try {
              this.ctx.sdk.call("openCamera", {}, (e => (e.error && 1 != e.error && n(new r(e.error, e.errorMessage)), t({
                uris: e.uris
              }))))
            } catch (t) {
      ...
      class U extends g {
        ...
        payOrder(e) {
          return new Promise(((t, n) => {
            ...
            o.payOrder({
              ...
              1 != (null == e ? void 0 : e.error) ? n(new r(e.error, e.message)) : t({
                code: 1,
                message: "Success"
              })
            }))
        ...
        renderResultCustomArea(e) {
          return new Promise(((t, n) => {
            this.ctx.sdk.call("renderResultCustomArea", e, (e => {
              1 != (null == e ? void 0 : e.error) ? n(new r(e.error, e.message)) : t({
                code: 1,
                message: "Success"
              })
      ...
      class B extends w {
        ...
        launchDeepLink(e) {
          return new Promise(((r, t) => {
            try {
              return this.ctx.sdk.call("launchDeeplink", {
                url: e.zpa
              }), r({
                message: "Success"
              })
          ...
          return new Promise(((r, t) => {
            try {
              let t = {
                url: e.url,
                options: {
                  showShareButton: e.showShareButton
                }
              };
              return this.ctx.sdk.call("launchPromotionWebApp", t), r({
                message: "Success"
              })
            } catch (e) {
              return t(e)
        ...
        setUIConfig(t) {
          let n = {};
          return t.statusBar && (n.statusBar = {
            backgroundColor: t.statusBar.backgroundColor || "",
            hidden: !1 !== t.statusBar.hidden
        ...
        shareFB(t) {
          return new Promise(((n, o) => {
            try {
              this.ctx.sdk.call("shareViaFacebook", t, (e => n({
                code: e.error
              })))
            } catch (t) {
              return o(new r(e, t.toString()))
      ...
      class K extends P {
        ...
        submitEventTracking(t, n) {
          return new Promise(((o, s) => {
            try {
              return t = k(t, v.ZPA), this.ctx.sdk.call("submitEventTracking", {
                eventId: t,
        ...
        trackScreen(t) {
          return new Promise(((n, o) => {
            try {
              return this.ctx.sdk.call("trackScreen", {
                screenName: t
              }), n(null)
            } catch (t) {
              return o(new r(e, t.toString()))
      ...
      class J extends c {
        ...
        onInitSuccess() {
          console.log("Init ZPA wrapper"), this.mUser = new b(this.ctx), this.mDevice = new N(this.ctx), this.mPayment = new U(this.ctx), this.mUI = new B(this.ctx), this.mTracking = new K(this.ctx)
        }
      }
      let V;
      ...
      const F = {
        init: function(e, t) {
          ...
          if (o && o.isZaloPay) {
            return M(new a(e, t, (function() {
              return window.ZaloPay
            })), J) ? V.init() : Promise.reject(new r(10001, "SDK have already initialized"))
          }
          if (n) {
            return M(new a(e, t, (function() {
              return window.ZPI_SPA_SDK
            })), I) ? V.init() : Promise.reject(new r(10001, "SDK have already initialized"))
          }
